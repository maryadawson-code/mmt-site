...
const AGENCIES = [
  ...
  },
  {
    ...
    acronyms: ["HRSA", "OPTN"],
    hints: ["health center program", "ryan white", "340b", "national health service corps", "optn modernization"],
  ...
  },
  {
    ...
    acronyms: ["ASPR", "BARDA"],
    hints: ["strategic national stockpile", "medical countermeasure", "medical countermeasures", "ez-baa"],
