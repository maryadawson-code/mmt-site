...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
  ...
  <tr><td style="padding:32px;">
    ...
    <a href="${portalUrl}" style="display:inline-block;background:#0A192F;color:#FFFFFF;padding:12px 28px;border-radius:6px;font-weight:700;font-size:15px;text-decoration:none;">View in My Reports</a>
