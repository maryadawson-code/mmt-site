...
5. Services/tools snapshot (ProposalPulse, Contract Tracker, Newswire, Glossary)
...
## Pages Hidden from Primary Nav
getting-started, proposal-pulse, marketpulse, contract-tracker, newswire, glossary, events, topics

## Footer Structure
Col 1: Brand + tagline
Col 2: Explore (Intelligence, Podcast, Resources, About)
