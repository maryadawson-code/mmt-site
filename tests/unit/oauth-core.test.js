...
describe("scope resolution", () => {
  it("intersects with granted scopes, defaults when none valid", () => {
    ...
    expect(resolveScopes("bogus:write")).toEqual(["opportunities:read", "intel:read", "reference:read", "states:read", "orgcharts:read"]);
    expect(resolveScopes("")).toEqual(["opportunities:read", "intel:read", "reference:read", "states:read", "orgcharts:read"]);
