---
title: "The Warfighter Under the Pendulum"
date: 2026-05-12
slug: the-warfighter-under-the-pendulum
description: "More than a decade of MHS reform has reshaped governance, authority, and budget. The warfighter has lived under all of it. Sergeant Reyes felt the pop in his knee on day three of train-up and waited thirty-seven days for an appointment. The pendulum has moved many times. The warfighter has not."
author: "Mary Womack"
category: deep-dive
visibility: public
tags:
...
agencies:
  ...
  - "U.S. Marine Corps"
  - SOCOM
canonical_url: "https://missionmeetstech.com/newsletter/the-warfighter-under-the-pendulum/"
source: claude_newsletter_project
capture_corner_teaser: "The FY2026 DHP justification's 65 percent purchased-care number, the December 2023 Hicks 7 percent re-attraction target by December 31 2026, the H2F workforce-and-facility map (129 brigades + ASTs + Serco $247M + H2FMS data backbone), the POTFF $500M to $1.5B IDIQ progression, True North Plus consolidating under AFMEDCOM, and the MSK wedge that ties access, recapture, network burn, and duty days into one capture surface."
capture_corner:
  - "Re-attraction heat map: market-by-market leakage by specialty, reason code, access standard, referral source, and network destination — mapped against the 7 percent re-attraction target."
  - "Necessary vs. avoidable network demand: position against avoidable leakage; hold the line on purchased care as a necessary part of the system."
  - "H2F as a portfolio, not a program: workforce, H2FAST, SPRC facilities, H2FMS, P3T, data, and ROI support tracked separately."
  - "POTFF as a market signal: the forecasted $1.5 billion single-award IDIQ (estimated solicitation release March 2026, estimated award October 2026, NAICS 621340) is a human-performance benchmark for the rest of DOD."
  - "MSK wedge: physical therapy access, MSK referral recapture, imaging and orthopedics bottleneck reduction, e-profile analytics, injury-prevention analytics tied to training calendars — duty-day restoration as the business case."
---
