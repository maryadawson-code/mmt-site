---
title: "Health Net Never Had a CMMC Deadline"
date: 2026-07-17
slug: health-net-never-had-a-cmmc-deadline
description: "The Department of War suspended third-party certification on July 13. The mechanism that cost Health Net's parent eleven million dollars was never part of it, and the network that mechanism asks you to vouch for is changing faster than the document describing it."
author: "Mary Womack"
category: deep-dive
visibility: public
tags:
...
agencies:
  ...
  - "DHA"
  - "VA"
canonical_url: "https://missionmeetstech.com/newsletter/health-net-never-had-a-cmmc-deadline/"
source: claude_newsletter_project
capture_corner_teaser: "This issue reads the exposure. The companion Capture Corner works the window: how to build an RFI response the task force will actually use before the August 14 close, what the record fills with if small firms sit it out, which cost lines carry evidentiary weight versus which read as complaint, how to separate 7012 spend from CMMC spend on paper so the relief you claim is the relief you get, the AI scope audit a capture lead should run on every teaming partner before the next award, and what the mid-September report is most likely to move first. It lives behind the paywall at missionmeetstech.com/pricing."
capture_corner:
...
This issue reads the exposure. The companion Capture Corner works the window: how to build an RFI response the task force will actually use before the August 14 close, what the record fills with if small firms sit it out, which cost lines carry evidentiary weight versus which read as complaint, how to separate 7012 spend from CMMC spend on paper so the relief you claim is the relief you get, the AI scope audit a capture lead should run on every teaming partner before the next award, and what the mid-September report is most likely to move first.
