---
title: "CMS Just Dropped the ClaimsCore RFP. The Last Time They Tried This, They Spent $40 Million and Failed."
date: 2026-03-07
slug: cms-just-dropped-the-claimscore-rfp-the-last-time-they-tried
description: "CMS released an RFP to replace four decades-old legacy claims processing systems with a single commercial platform. This procurement learned from previous federal failures, emphasizing competition, prototypes, and COTS over custom development."
tags:
...
Run the draft through [ProposalPulse](/proposal-pulse.html) to catch the places where the COTS story reads like disguised customization and where the prototype narrative is thinner than it needs to be.

If your capture team needs a clean read on CMS acquisition history and who else is positioning around ClaimsCore, that is a [MarketPulse](/marketpulse.html) brief. One free, 24-hour delivery.

Mary's full LinkedIn analysis of the ClaimsCore RFP is [here](https://www.linkedin.com/pulse/cms-just-dropped-claimscore-rfp-last-time-tried-spent-mary-womack-yueze) for readers who want the original.
