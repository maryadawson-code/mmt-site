...
agencies:
  ...
  - USSOCOM
  - DoD
canonical_url: "https://missionmeetstech.com/newsletter/recruiting-was-the-easy-part/"
source: claude_newsletter_project
capture_corner_teaser: "Premium subscribers get the companion Capture Corner: the vehicle-by-vehicle read on the FY2027 human-performance cliff. The Serco H2F follow-on and what its firm-fixed-price structure does to a cost-plus staffing habit, POTFF III as a single-award winner-take-all play with KBR defending, the Gen VI HRS vehicle that gates Army access underneath both, and the NAICS size-standard map that decides which small business is allowed to compete in which lane."
capture_corner:
  - "The anchor recompete: the Army H2F follow-on (W15QKN26R1B6H) is on the street as a five-year firm-fixed-price under NAICS 541612, where cost-realism scrutiny punishes a staffing-hours bid and the $29M size standard opens a deep field. The incumbent to beat, the protest record that tests it, and the wedge a challenger actually has."
  - "The marquee, priced as winner-take-all: POTFF III (~$955M, single-award IDIQ, NAICS 621340) hands one company the entire SOF human-performance mission for eight years. Why that justifies a heavier B&P than a multiple-award vehicle, the no-gap transition theme that decides it, and the OCI posture to clear before the industry day."
...
This issue maps the market. The companion Capture Corner maps the recompete. Premium subscribers get the vehicle-by-vehicle read on the FY2027 cliff: the Serco H2F follow-on and what the sources-sought signals, POTFF III as a single-award winner-take-all play with KBR defending, the Gen VI HRS vehicle behind it all, the NAICS strategy that decides which small businesses compete under which service, and the teaming and organizational-conflict signals a capture lead needs before the next industry day.
