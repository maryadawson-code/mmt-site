...
CREATE TABLE penny_token_usage (
...
CREATE INDEX idx_token_agent ON penny_token_usage(agent_id);
CREATE INDEX idx_token_model ON penny_token_usage(model);
CREATE INDEX idx_token_date ON penny_token_usage(recorded_at);
CREATE INDEX idx_token_task_type ON penny_token_usage(task_type);

-- Model Pricing Reference
CREATE TABLE penny_model_pricing (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE INDEX idx_penny_findings_status ON penny_findings(status);
CREATE INDEX idx_penny_findings_type ON penny_findings(finding_type);

-- Daily Cost Summary
CREATE TABLE penny_daily_summary (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE INDEX idx_penny_daily_date ON penny_daily_summary(summary_date);

-- Model Routing Rules
CREATE TABLE penny_routing_rules (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  agent_id TEXT NOT NULL,
